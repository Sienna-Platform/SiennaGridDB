...
CREATE TABLE transformer_circuits (
    ...
    regulated_bus_side TEXT NULL DEFAULT 'UNDEFINED' CHECK (regulated_bus_side IN ('UNDEFINED', 'CONTROLLING_WINDING', 'OPPOSITE_WINDING')),
    load_drop_compensation_r REAL NULL DEFAULT 0.0, -- Units: per parameter_units (COMPONENT_BASE: pu, NATURAL_UNITS: ohm)
    load_drop_compensation_x REAL NULL DEFAULT 0.0, -- Units: per parameter_units (COMPONENT_BASE: pu, NATURAL_UNITS: ohm)
